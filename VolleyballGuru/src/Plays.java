...
public class Plays {
	...
	public static void oOSplays() {
		// outofsystem
		System.out.println(
				"An Out-Of-System play is when the Setter passes the first ball, so the Libero has to set. \n Two plays can be run Out-Of-System. \tWould you like to: ");
